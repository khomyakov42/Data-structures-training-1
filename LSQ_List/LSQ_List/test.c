...
int main()
{
    ...
    TEST
        test_assert(LSQ_IsIteratorDereferencable(LSQ_HandleInvalid) == 0);
        test_assert(LSQ_IsIteratorPastRear(LSQ_HandleInvalid) == 0);
        test_assert(LSQ_IsIteratorBeforeFirst(LSQ_HandleInvalid) == 0);
    ENDTEST

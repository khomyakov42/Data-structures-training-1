...
typedef int LSQ_KeyT;

typedef int LSQ_SizeT;

typedef void* LSQ_Callback_CloneFuncT (void*);//приведение типов value & key
typedef size_t LSQ_Callback_SizeFuncT (void*);//длина ключа
typedef int LSQ_Callback_CompareFuncT (void*, void*);//сравнение элементов
